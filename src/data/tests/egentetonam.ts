...
export const EGENTETONAM_TEST = {
  code: "egentetonam",
  docId: "egentetonam",
  title: "당신의 호르몬 성향 에겐남 vs 테토남",
  description: "10가지 질문으로 알아보는 나의 성향! 에겐남일까, 테토남일까?",
  bgGradient: "from-[#f8fafc] via-[#e0e7ff] to-[#f0fdfa]", // 연보라~연파랑~연민트
  mainColor: "#6c5ce7",
  icon: "💧🔥",
  thumbnailUrl: "/thumbnails/egentetonam_thumb.png",
  tags: ["에겐", "테토", "연애"],
  seoKeywords: "에겐남, 테토남, 호르몬 테스트, 심리 테스트, 연애 테스트",
  views: 0,
  likes: 0,
  scraps: 0,
  category: "밈",
